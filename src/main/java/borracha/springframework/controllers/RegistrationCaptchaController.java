...
import borracha.springframework.captcha.CaptchaService;
...
public class RegistrationCaptchaController {
    ...
    @ResponseBody
    public GenericResponse captchaRegisterUserAccount(@Valid final UserCommand accountDto, final HttpServletRequest request) {
