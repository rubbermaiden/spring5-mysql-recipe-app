...
import borracha.springframework.security.google2fa.CustomAuthenticationProvider;
import borracha.springframework.security.google2fa.CustomWebAuthenticationDetailsSource;
...
@Configuration
@ComponentScan(basePackages = { "borracha.springframework.security" })
