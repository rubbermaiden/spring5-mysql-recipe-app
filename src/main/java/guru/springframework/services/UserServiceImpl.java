...
import guru.springframework.repositories.PasswordResetTokenRepository;
...
public class UserServiceImpl implements UserService {
  ...
  @Override
  public User registerNewUserAccount(final UserCommand accountDto) {
  ...
  public List<String> getUsersFromSessionRegistry() {
    return sessionRegistry.getAllPrincipals().stream().filter((u) -> !sessionRegistry.getAllSessions(u, false).isEmpty()).map(Object::toString).collect(
        Collectors.toList());
  }
