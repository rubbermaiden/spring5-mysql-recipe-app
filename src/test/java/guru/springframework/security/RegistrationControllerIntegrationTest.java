...
import guru.springframework.spring.TestIntegrationConfig;
...
@SpringBootTest(classes = { Spring5RecipeAppApplication.class, TestDbConfig.class, TestIntegrationConfig.class }, webEnvironment = WebEnvironment.RANDOM_PORT)
@Transactional
